...
$plan = new Plan();
$plan->setName('K-flix monthly subscription plan')
...
$paymentDefinition->setName('Regular Payments')
  ...
  ->setAmount(new Currency(array('value' => 9.99, 'currency' => 'INR')));
...
$merchantPreferences->setReturnUrl($returnUrl . "?success=true")
  ...
  ->setSetupFee(new Currency(array('value'=>9.99,'currency'=>'INR')));
